...
/* This is a modified version of the internal loader.h function used by freebl.
 * Normally applications will access these functions via a static library
 * supplied by freebl and used */

#ifndef _LOADER_H_
#define _LOADER_H_ 1

/* include enough typedefs from blapii.h to compile */
#include <seccomon.h>
#include <blapit.h>
#include <hasht.h>
#include <alghmac.h>
