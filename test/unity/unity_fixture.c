                     ...
                     unsigned int line)
{
    if (testSelected(name) && groupSelected(group))
    {
        ...
        #endif
            /* BEGIN LIBACVP MODIFICATION: Add newline after test name for cleaner output */
            UNITY_PRINT_EOL();
            /* END LIBACVP MODIFICATION */
        }
        ...
        {
            /* BEGIN LIBACVP MODIFICATION: Suppress dots in non-verbose mode for cleaner output */
            /* UNITY_OUTPUT_CHAR('.'); */
            /* END LIBACVP MODIFICATION */
        }
...
void UnityConcludeFixtureTest(void)
{
    ...
    else if (!Unity.CurrentTestFailed)
    {
        if (UnityFixture.Verbose)
        {
            /* BEGIN LIBACVP MODIFICATION: Remove leading space before PASS */
            /* UnityPrint(" "); */
            /* END LIBACVP MODIFICATION */
