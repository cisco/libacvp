...
TEST_GROUP(APP_DES_HANDLER);

static ACVP_TEST_CASE *test_case = NULL;
static ACVP_SYM_CIPHER_TC *des_tc = NULL;
...
TEST_SETUP(APP_DES_HANDLER) {}
TEST_TEAR_DOWN(APP_DES_HANDLER) {}
...
TEST(APP_DES_HANDLER, bad_keylen) {
    ...
    if (!initialize_des_tc(des_tc, ACVP_TDES_CBC, payload, 32, NULL, 0,
        ...
        TEST_FAIL_MESSAGE("des init tc failure");
    }
