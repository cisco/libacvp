...
TEST_GROUP(APP_AES_AEAD_HANDLER);
TEST_GROUP(APP_AES_HANDLER);
TEST_GROUP(APP_AES_KW_HANDLER);

static ACVP_TEST_CASE *test_case = NULL;
static ACVP_SYM_CIPHER_TC *aes_tc = NULL;
...
TEST_SETUP(APP_AES_AEAD_HANDLER) {}
TEST_TEAR_DOWN(APP_AES_AEAD_HANDLER) {}

TEST_SETUP(APP_AES_HANDLER) {}
TEST_TEAR_DOWN(APP_AES_HANDLER) {}

TEST_SETUP(APP_AES_KW_HANDLER) {}
TEST_TEAR_DOWN(APP_AES_KW_HANDLER) {}
...
TEST(APP_AES_AEAD_HANDLER, missing_msg) {
    ...
    if (!initialize_aes_tc(aes_tc, ACVP_AES_GCM, payload, 32, NULL, 0,
        ...
        TEST_FAIL_MESSAGE("aes init tc failure");
    }
