...
static void setup(void) {
    ...
    rv = acvp_cap_set_prereq(ctx, ACVP_KAS_HKDF, ACVP_PREREQ_HMAC, cvalue);
    cr_assert(rv == ACVP_SUCCESS);
    ...
    cr_assert(rv == ACVP_SUCCESS);
    rv = acvp_cap_set_prereq(ctx, ACVP_KAS_KDF_ONESTEP, ACVP_PREREQ_HMAC, cvalue);
    cr_assert(rv == ACVP_SUCCESS);
 ...
 */
Test(KAS_KDF_API, empty_ctx) {
    setup_empty_ctx(&ctx);

    val = json_parse_file("json/kas_kdf/kas_hkdf_1.json");
    ...
    rv  = acvp_kas_hkdf_kat_handler(ctx, obj);
    cr_assert(rv == ACVP_UNSUPPORTED_OP);
    rv = ACVP_SUCCESS;
    json_value_free(val);

    val = json_parse_file("json/kas_kdf/kas_kdf_onestep_1.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        goto end;
    ...
    rv = acvp_kas_kdf_onestep_kat_handler(ctx, obj);
    cr_assert(rv == ACVP_UNSUPPORTED_OP);
    json_value_free(val);
...
Test(KAS_KDF_API, null_ctx) {
    ...
    rv  = acvp_kas_hkdf_kat_handler(NULL, obj);
    ...
    rv  = acvp_kas_kdf_onestep_kat_handler(NULL, obj);
    cr_assert(rv == ACVP_NO_CTX);
    json_value_free(val);
}
 ...
 */
Test(KAS_KDF_API, null_json_obj, .init = setup, .fini = teardown) {
    rv  = acvp_kas_hkdf_kat_handler(ctx, NULL);
    cr_assert(rv == ACVP_MALFORMED_JSON);
    rv = ACVP_SUCCESS;
    rv  = acvp_kas_kdf_onestep_kat_handler(ctx, NULL);
    cr_assert(rv == ACVP_MALFORMED_JSON);
 ...
 * Expecting success.
 */
Test(KAS_KDF_HANDLER, good, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_1.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
 ...
 */
Test(KAS_HKDF_HANDLER, missing_algorithm, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_2.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_mode, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_3.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, bad_mode, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_4.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_type, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_5.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, bad_type, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_6.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_kdfConfiguration, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_7.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_l, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_8.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_saltmethod, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_10.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, bad_saltmethod, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_11.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_fixedinfoencoding, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_12.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, bad_fixedinfoencoding, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_13.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_hmacalg, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_14.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, bad_hmacalg, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_15.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_fixedinfopattern, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_16.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, empty_fixedinfopattern, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_17.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, bad_hex_fixedinfopattern, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_18.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_vpartyinfo_fixedinfopattern, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_19.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_upartyinfo_fixedinfopattern, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_20.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 * HKDF: missing salt
 */
Test(KAS_HKDF_HANDLER, missing_salt, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_21.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 * HKDF: missing Z
 */
Test(KAS_HKDF_HANDLER, missing_z, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_22.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_fixedinfopartyu, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_23.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_upartyid, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_24.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_fixedinfopartyv, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_25.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_vpartyid, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_26.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_algorithmid, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_27.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_label, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_28.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_HKDF_HANDLER, missing_context, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_hkdf_29.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_KDF_ONESTEP_HANDLER, missing_algorithm, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_kdf_onestep_2.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_KDF_ONESTEP_HANDLER, missing_mode, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_kdf_onestep_3.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_KDF_ONESTEP_HANDLER, wrong_mode, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_kdf_onestep_4.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_KDF_ONESTEP_HANDLER, missing_auxfunction, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_kdf_onestep_5.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
 ...
 */
Test(KAS_KDF_ONESTEP_HANDLER, bad_auxfunction, .init = setup, .fini = teardown) {
    val = json_parse_file("json/kas_kdf/kas_kdf_onestep_6.json");
    obj = ut_get_obj_from_rsp(val);
    if (!obj) {
        ACVP_LOG_ERR("JSON obj parse error");
        return;
